...
function back(){
  ...
  function formulario(){
    ...
    try {
      ...
      return resultado.innerHTML = 'Field '+err+' is invalid!';
    }
    ...
    resultado.innerHTML ='<label>Nome:'+user.name+'</label><label>Data de aniversário:'+user.birthdate+'</label><label>Peso:'+user.weight+'</label><label>Altura:'+user.height+'</label><label>Gênero:'+user.gender+'</label>';
